...
bookNowBtn.addEventListener("click", function() {
    ...
    document.getElementById('flying-from-name').innerHTML =
        document.getElementById("flyingfrom").value;
    document.getElementById('flying-to-name').innerHTML =
        document.getElementById("flyingto").value;
    document.getElementById('departure_display').innerHTML =
        document.getElementById("departure_date").value;
    document.getElementById('return_display').innerHTML =
